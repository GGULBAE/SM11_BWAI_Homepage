...
export default function APIUsage({ apiKey }) {
  ...
  return <APIUsageWrapper>
    <APIUsageOptions setSetting={setSetting} />
    <ChartWrapper>
...
const APIUsageWrapper = styled.div`
  margin: 24px;
